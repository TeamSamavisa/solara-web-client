...
import { ShiftSkeletonRows } from './ShiftSkeletonRows';
...
export const ShiftList: React.FC<ShiftsListProps> = ({
  shifts,
  onEdit,
  onDelete,
  isLoading,
              ...
              >
                ...
                {isAdmin && (
                  <TableCell className="text-right">
                    <DropdownMenu
                      open={openDropdown === shift.id}
                      onOpenChange={(open) =>
                        setOpenDropdown(open ? shift.id : null)
                      }
                    >
