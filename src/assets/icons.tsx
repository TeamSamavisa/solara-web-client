...
export {
  ...
  FaBook as Book,
  HiAcademicCap as Student,
  FaChalkboardTeacher as Teacher,
  RiHome2Fill as Home,
  IoCalendar as Calendar,
  FaUser as User,
  FaUsers as Users,
  IoArrowBack as Return,
  BiSolidUpArrow as UpArrow,
  BiSolidRightArrow as RightArrow,
  BiSolidDownArrow as DownArrow,
  BiSolidLeftArrow as LeftArrow,
  FaClock as Clock,
  FaRegTrashCan as Trash,
  MdModeEditOutline as Pencil,
  FaTrash as TrashAlt,
  FaCopy as Copy,
  IoIosArrowBack as ReturnAlt,
  MdAddBox as AddBox,
  FaEdit as Edit,
  FaPlus as PlusSign,
  FaSearch as Search,
